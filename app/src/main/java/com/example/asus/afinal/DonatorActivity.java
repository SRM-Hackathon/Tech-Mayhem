                                ...
                                if (Build.VERSION.SDK_INT<23 || ContextCompat.checkSelfPermission(DonatorActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                                    ...
                                    if (lastKnownLocation!=null){
                                        ...
                                        handler.postDelayed(new Runnable() {
                                            ...
                                            markers.add(mMap.addMarker(new MarkerOptions().position(requestLoactionLatLng).title("Your Location").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))));
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> list, ParseException e) {
                    if(e==null){
                        ...
                        requestActive = false;
                            callButton.setText("Call for Pickup");
                        }
                ...
                if (lastKnownLocation!=null){
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e==null){
                                callButton.setText("Cancel pickup");
                                requestActive=true;
                                checkForUpdates();
                            }
                        }
                    ...
                    Toast.makeText(this, "Could not find loaction. Please try again later", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode ==1){
            if(grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                if (ContextCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOACTION )== PackageManager.PERMISSION_GRANTED){
                    locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,0,0,locationListener);
                    Location lastKnownLocation = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);
